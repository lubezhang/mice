...
# Dump of table imghash
# ------------------------------------------------------------

DROP TABLE IF EXISTS `imghash`;

CREATE TABLE `imghash` (
...
LOCK TABLES `imghash` WRITE;
/*!40000 ALTER TABLE `imghash` DISABLE KEYS */;

INSERT INTO `imghash` (`id`, `basename`, `md5`)
VALUES
...
/*!40000 ALTER TABLE `imghash` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `article` (`id`, `user_id`, `category_id`, `title`, `content`, `date`, `status`, `modify_date`, `modify_user_id`)
VALUES
...
INSERT INTO `post_tag` (`id`, `post_id`, `tag_id`, `status`)
VALUES
	(41,166,5,1),
	(42,166,4,1);
...
INSERT INTO `user` (`id`, `username`, `password`, `nickname`, `email`, `group`, `status`, `add_time`, `add_ip`, `last_login_time`, `last_login_ip`, `login_count`)
VALUES
